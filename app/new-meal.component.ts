...
@Component({
  ...
  template: `
    <div class="meal-form">
      ...
      <input placeholder="Name" type="text" class="input-md" #newName><br><br>
      <input placeholder="Details" type="text" class="input-md" #newDetails><br><br>
      <input placeholder="Calories" type="number" class="input-md" #newCalories><br><br>
